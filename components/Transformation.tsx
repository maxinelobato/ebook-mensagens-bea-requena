      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          <Reveal>
            ...
            <p className="text-gray-500">Veja como sua comunicação vai mudar com o método</p>
          </Reveal>
        </div>
        ...
        <Reveal delay={200}>
          <div className="grid md:grid-cols-2 gap-0 rounded-[40px] overflow-hidden shadow-2xl border border-[#E5D5C8]">
            ...
            <div className="bg-white p-10 md:p-16 border-b md:border-b-0 md:border-r border-[#E5D5C8]">
              <h3 className="text-2xl font-serif text-gray-400 mb-8 uppercase tracking-widest">Antes do Guia</h3>
